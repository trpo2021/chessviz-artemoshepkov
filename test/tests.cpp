...
TEST_CASE(
        "CheckRangeX() function should return 1 if the X coordinates given by "
        "the user do not fall out of the range of the board boundaries, "
...
TEST_CASE(
        "CheckRangeY() function should return 1 if the Y coordinates given by "
        "the user do not fall out of the range of the board boundaries, "
        "otherwise it will return 0")
{
    coord test1, test2;
...
TEST_CASE(
        "CheckType() function should return 1 if the shape type entered by the "
        "user matches the shape on the board, otherwise 0 is output")
{
    char board[9][9]
            = {{'8', 'r', 'n', 'b', 'q', 'k', 'b', 'n', 'r'},
               {'7', 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p'},
